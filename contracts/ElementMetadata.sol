                ...
                abi.encodePacked(
                    bytes(
                        abi.encodePacked(
                            ...
                            "Element Protocol",
                            '", "image": "',
                            imageIpfsUrls[data.race][data.gender],
                            '", "attributes": ',
                            "[",
                            '{"trait_type": "Race",',
                            '"value":"',
                            raceStrings[data.race],
                            '"},',
                            '{"trait_type": "Gender",',
                            '"value":"',
                            genderStrings[data.gender],
                            '"},',
                            '{"trait_type": "Class",',
                            '"value":"',
                            classStrings[data.class],
                            '"},',
                            '{"trait_type": "Strength",',
                            '"value":"',
                            Strings.toString(data.stats.strength),
                            '"},',
                            '{"trait_type": "Dexterity",',
                            '"value":"',
                            Strings.toString(data.stats.dexterity),
                            '"},',
                            '{"trait_type": "Charisma",',
                            '"value":"',
                            Strings.toString(data.stats.charisma),
                            '"},',
                            '{"trait_type": "Wisdom",',
                            '"value":"',
                            Strings.toString(data.stats.wisdom),
                            '"},',
                            '{"trait_type": "Intelligence",',
                            '"value":"',
                            Strings.toString(data.stats.intelligence),
                            '"},',
                            '{"trait_type": "Constitution",',
                            '"value":"',
                            Strings.toString(data.stats.constitution),
                            '"}',
                            "]",
                            "}"
                        )
